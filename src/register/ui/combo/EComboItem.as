package register.ui.combo
{
	...
	public class EComboItem extends MovieClip
	{
		...
		public var colors:Array=[0x000000,0xF90000];
		public function EComboItem() 
		{
			...
			//txt_label.defaultTextFormat=new TextFormat("Calisto MT", 14,null,true);;
			txt_label.textColor=0x002E5B;//colors[0];
		...
		public function onMOUver(e:MouseEvent):void 
		{
			...
			TweenMax.to(txt_label,0.5,{tint:0x00})
		}
